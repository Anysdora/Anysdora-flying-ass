...
//以下两个函数专用于支持MPU6050的DMP
s8 MPU_Write_Len(unsigned char slave_addr, unsigned char reg_addr,unsigned char length, unsigned char const *data);
s8 MPU_Read_Len(unsigned char slave_addr, unsigned char reg_addr,unsigned char length, unsigned char *data);
